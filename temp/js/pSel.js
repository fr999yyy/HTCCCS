         ...
         <li class="list-group-item bg-transparent">
          ...
          <div class="collapse" id="collapseC${sectionNumber}1">
            <div class="bg-light bg-gradient card card-body border-0 d-flex flex-row align-items-start justify-content-between mt-1">
               <div id="classInfo${sectionNumber}" class="w-75">${classInfo}<br>123123123</div>
                <div class="ms-4 text-end" style="width: 180px;">
                <img src="assets/${pfp}.jpg" class="rounded-circle profile" alt="" id="pfp${sectionNumber}" />
                <img src="assets/${pfp}.jpg" class="rounded-circle profile" alt="" id="pfp${sectionNumber}" />
                </div>
