...
urlpatterns = [
    ...
    path('team_results_lookup/', views.team_results_lookup, name='team_results_lookup'),
    path('course_results_lookup/', views.course_results_lookup, name='course_results_lookup'),
    path('selection_lookup/', views.selection_lookup, name='selection_lookup'),
    ...
    path('select_form/<int:form_stage>', views.select_form, name='select_form'),
    path('get_courses/', views.get_courses, name='get_courses'),
    path('select_form/double_check', views.double_check, name='double_check'),
    path('select_form/confirm', views.confirm, name='confirm'),
    path('select_form/confirm/submit_form', views.submit_form, name='submit_form'),
